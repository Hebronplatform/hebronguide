...
|---|---|---|---|---|---|
| **연합뉴스** (Yonhap) | en.yna.co.kr | ✅ | 통신사 | 중립 | **국가기간통신사. DC·NY·LA·SF·ATL·CHI 특파원 상주. 팩트 신뢰도 최상** |
| **KBS America** | kbsworldi.com | ✅ | TV+웹 | 중도 | 2004년 개국, LA 기반 독자 편집국. 미주 한인 뉴스 제작 |
| **SBS International** | lalasbs.com | ✅ | TV+웹 | 중도 | LA 기반 (3530 Wilshire Blvd). 미주 로컬 뉴스팀 별도 운영. 상업방송·정치색 적음 |
...
```
✅ 팩트 기반 신뢰:  연합뉴스(en.yna.co.kr), KBS America, SBS International
                   → 성경적 세계관 필터 후 사실 정보 활용

⚠️ 선별 사용:      MBC America, 미주조선일보
                   → 보수/진보 성향 감안, 사설·칼럼 제외, 사실 정보만

🚫 사용 금지:      세계일보 / The Washington Times
                   → 통일교(이단) 계열 — 인용·취재·연계 전면 금지

❌ 미주 서비스 無:  동아·한겨레·경향·서울신문·문화일보·국민일보 등
```
