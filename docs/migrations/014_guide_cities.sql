...
VALUES
  ...
  ('federalway', '페더럴웨이', 'Federal Way', 'Washington', '미국', '미국', '#14B8A6', '🌊', '🇺🇸', 'live', '한인 밀집', '페더럴웨이에서 함께 정착하다', 'Settle together in Federal Way.', 'Establécete junto a otros en Federal Way.', NULL, '[]'::jsonb, 47.3223, -122.3126, 2),
