...
K.push(box([
  rich([{t:"오늘 확인한 것: ",b:true,c:RISK},{t:"페더럴웨이 페이지의 keywords 메타태그가 아직 시애틀 키워드 그대로입니다. 손으로 복제하셨다는 증거이고, 나머지 81개 도시 중 몇 개가 같은 상태인지 지금은 알 수 없습니다."}],{after:0})
],TINT_R,RISK));
K.push(gap(160));
...
K.push(bullet("SEO 메타태그를 도시명에 맞게 전부 교체합니다 — 페더럴웨이 같은 복제 잔재를 원천 차단합니다."));
...
K.push(table(
  ...
  [
    ...
    ["3","hebron-meta-audit","82개 도시 메타태그·구조화 데이터 전수 점검","페더럴웨이 같은 복제 잔재를 찾아내 SEO 유입 확보"],
