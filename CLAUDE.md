...
```
HebronGuide ≠ 단순한 지역 정보 앱
HebronGuide = 문화 상품 + 글로벌 커뮤니티 + 그리스도의 빛
```
...
| 기둥 | 의미 | 코드/콘텐츠에 적용 |
|---|---|---|
| **① 문화 상품 제작** | 콘텐츠 자체가 자랑할 상품 | 김구 인용·한인 캘린더·영웅 시리즈 |
| **② 글로벌 한인 커뮤니티** | 700만 재외 한인 디지털 인프라 | 9개 도시 → 글로벌 확장 |
| **③ 교회 이미지를 밝게** | 강요 없이 자연스럽게 빛남 | 환대·검증·섬김으로 보여주기 |

### 작업 전 3가지 질문 (의사결정 프레임)

```
□ 이것이 자랑스러운 문화 상품이 되는가?
□ 이것이 글로벌 한인 커뮤니티에 기여하는가?
□ 이것이 교회·그리스도의 빛을 밝게 하는가?

→ 3가지 모두 YES면 진행, 하나라도 NO면 재검토
```
...
**HebronGuide = 디지털 시대의 「나의 소원」 실현 도구**
