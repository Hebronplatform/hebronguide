...
```
0. 내가 사용자라면 이걸 받고 싶을까? ← 가장 중요 (황금률)
...
→ 6가지 모두 YES일 때만 진행 / 0번 NO면 ❌
```

### Hard Rules (절대 금지)

❌ 직접 전도 / 성경 도배 / 검증 안 된 정보 / 데이터 판매 / 광고 위장 / 민족주의 / 일요일 상업 활동 / 교회·LLC 자금 혼용 / 이단 등재 / AI 추측 데이터
...
| [`DIASPORA_STRATEGY.md`](docs/DIASPORA_STRATEGY.md) | BTS·디아스포라 확산 |
