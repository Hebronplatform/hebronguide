...
// ─── 취업 ─────────────────────────────────────────────────
export const DEFAULT_JOBS: PlaceItem[] = [
  { id: pid(), emoji: "☁️", name: "Amazon", nameEn: "Amazon — Largest Seattle Employer",
    desc: "✅ 시애틀 최대 고용주. South Lake Union 본사. SDE·PM·데이터사이언티스트·운영직. AWS 글로벌 본부. 한인 직원 수천 명. L3-L7 레벨. 연봉 $120K-$350K+ | 🔗 amazon.jobs",
    descEn: "✅ Seattle's largest employer. SLU HQ. SDE, PM, data scientist, operations. AWS global HQ. Thousands of Korean employees. L3-L7 levels. Salary $120K-$350K+ | 🔗 amazon.jobs",
    tags: ["빅테크", "SDE", "H-1B"], active: true, order: 0 },
  { id: pid(), emoji: "🖥️", name: "Microsoft", nameEn: "Microsoft — Redmond HQ",
    desc: "✅ 레드몬드 본사. Azure·Office·Xbox·Copilot. 한인 엔지니어 매우 많음. H-1B 스폰서 적극적. 연봉 $130K-$380K+ | 🔗 careers.microsoft.com",
    descEn: "✅ Redmond HQ. Azure, Office, Xbox, Copilot. Large Korean engineer community. Active H-1B sponsor. Salary $130K-$380K+ | 🔗 careers.microsoft.com",
    tags: ["빅테크", "레드몬드", "비자지원"], active: true, order: 1 },
  { id: pid(), emoji: "🔍", name: "Google Seattle", nameEn: "Google — Kirkland & Seattle",
    desc: "커클랜드·시애틀 캠퍼스. YouTube·검색·지도·AI. 최상위 보상 패키지. 경쟁 치열 | 🔗 careers.google.com",
    descEn: "Kirkland & Seattle campuses. YouTube, Search, Maps, AI. Top-tier compensation. Very competitive | 🔗 careers.google.com",
    tags: ["빅테크", "커클랜드", "AI"], active: true, order: 2 },
  { id: pid(), emoji: "✈️", name: "Boeing", nameEn: "Boeing — Aerospace",
    desc: "에버렛·렌톤 위치. 에어로스페이스 엔지니어링. 기계·항공·전기 엔지니어 수요. 보안 허가 필요 | 🔗 boeing.com/careers",
    descEn: "Everett & Renton locations. Aerospace engineering. Mechanical, aero & electrical engineers needed. Security clearance required | 🔗 boeing.com/careers",
    tags: ["항공", "엔지니어링", "에버렛"], active: true, order: 3 },
  { id: pid(), emoji: "🏥", name: "의료·바이오 취업", nameEn: "Healthcare & Biotech Jobs",
    desc: "UW Medicine·Swedish·Kaiser·Virginia Mason. 간호사·의사·연구직. 워싱턴주 간호사 부족 → 비교적 취업 용이. 의료 비자 경로 있음 | 🔗 careers.uwmedicine.org",
    descEn: "UW Medicine, Swedish, Kaiser, Virginia Mason. Nurses, doctors, researchers. WA nurse shortage → easier hiring. Medical visa pathways available | 🔗 careers.uwmedicine.org",
    tags: ["의료", "간호사", "바이오"], active: true, order: 4 },
  { id: pid(), emoji: "🍽️", name: "한인 자영업 가이드", nameEn: "Korean Small Business Guide",
    desc: "린우드·페더럴웨이 중심. 진입 가능 업종: 한식당·BBQ·치킨, 미용실·네일, 세탁소, 편의점, 한인 부동산·보험, 한국 식품 유통. 초기 자본 $50K-$150K. 한인 상공회의소 멘토링 활용",
    descEn: "Lynnwood & Federal Way. Entry-possible: Korean restaurants, hair/nail salons, dry cleaning, convenience stores, real estate, insurance, food import. Capital $50K-$150K. Korean Chamber mentoring",
    tags: ["자영업", "창업", "린우드"], active: true, order: 5 },
  { id: pid(), emoji: "💼", name: "취업 비자 안내", nameEn: "Work Visa Guide",
    desc: "• H-1B: 전문직. 스폰서 필요. 연 1회 추첨. Amazon·MS 적극 지원\n• L-1: 사내 이동 (한국 → 미국)\n• OPT/STEM OPT: 졸업 후 1-3년\n• EB-2/EB-3: 취업 영주권\n• E-2: 투자 비자 (자영업 창업)",
    descEn: "• H-1B: Specialty occupation, needs sponsor, annual lottery\n• L-1: Intracompany transfer (Korea → US)\n• OPT/STEM OPT: 1-3 years post-grad\n• EB-2/EB-3: Employment-based green card\n• E-2: Investment visa (self-employment)",
    tags: ["H-1B", "비자", "영주권"], active: true, order: 6 },
  { id: pid(), emoji: "💡", name: "한인 취업 네트워크", nameEn: "Korean Job Networks",
    desc: "• KAA (Korean American Association) — Amazon 내 한인 네트워크\n• KABA — 비즈니스 네트워크\n• UW·시애틀U 한인 동문 네트워크\n• LinkedIn 프로필 최적화 필수\n• LeetCode 코딩 인터뷰 준비 (빅테크)\n• 교회 소그룹 — 의외로 강력한 채용 연결",
    descEn: "• KAA — Korean network inside Amazon\n• KABA — Business network\n• UW/Seattle U Korean alumni\n• LinkedIn profile optimization essential\n• LeetCode coding interview prep (Big Tech)\n• Church small groups — powerful job connections",
    tags: ["네트워크", "LinkedIn", "KAA"], active: true, order: 7 },
];

// ─── 교육 ─────────────────────────────────────────────────
export const DEFAULT_EDUCATION: PlaceItem[] = [
  { id: pid(), emoji: "⭐", name: "Bellevue School District", nameEn: "Bellevue SD — WA #1",
    desc: "✅ 워싱턴주 1위 학군 (Niche A+). 졸업률 92.5%. 수학 69%, ELA 75%. Newport HS·Interlake HS·Bellevue HS. AP·IB 과정 풍부. 한인 학생 비율 높음 | 🔗 bsd405.org",
    descEn: "✅ WA State #1 district (Niche A+). Graduation 92.5%. Math 69%, ELA 75%. Newport, Interlake & Bellevue HS. Rich AP/IB programs. High Korean student population | 🔗 bsd405.org",
    tags: ["벨뷰", "A+", "상위학군"], active: true, order: 0 },
  { id: pid(), emoji: "⭐", name: "Mercer Island SD", nameEn: "Mercer Island SD — WA #2",
    desc: "✅ 워싱턴주 2위 학군 (Niche A+). 졸업률 97.2%. 수학 83.8%, ELA 88%. Mercer Island HS (전국 상위 1%). 고소득 전문직 가정 밀집 | 🔗 mercerislandschools.org",
    descEn: "✅ WA #2 district (Niche A+). Graduation 97.2%. Math 83.8%, ELA 88%. Mercer Island HS (top 1% nationally). High-income professional families | 🔗 mercerislandschools.org",
    tags: ["메르서아일랜드", "A+", "최상위"], active: true, order: 1 },
  { id: pid(), emoji: "⭐", name: "Lake Washington SD", nameEn: "Lake Washington SD — Redmond·Kirkland",
    desc: "✅ 워싱턴주 상위 1% (Niche A+). 졸업률 95%. 수학 73%, ELA 81%. Lake Washington HS·Eastlake HS·Redmond HS. MS 본사 인근. STEM 최강 | 🔗 lwsd.org",
    descEn: "✅ Top 1% in WA (Niche A+). Graduation 95%. Math 73%, ELA 81%. Near Microsoft HQ. Exceptional STEM programs | 🔗 lwsd.org",
    tags: ["레드몬드", "커클랜드", "STEM"], active: true, order: 2 },
  { id: pid(), emoji: "⭐", name: "Northshore SD", nameEn: "Northshore SD — Bothell·Woodinville",
    desc: "✅ 워싱턴주 상위 5% (Niche A). 졸업률 96%. Inglemoor HS·Bothell HS·Woodinville HS. 한인 가족 최다 거주 학군. 우수한 STEM·예술 프로그램 | 🔗 nsd.org",
    descEn: "✅ Top 5% in WA (Niche A). Graduation 96%. Inglemoor, Bothell & Woodinville HS. Highest Korean family concentration. Strong STEM & arts | 🔗 nsd.org",
    tags: ["보텔", "우딘빌", "한인밀집"], active: true, order: 3 },
  { id: pid(), emoji: "🎓", name: "University of Washington (UW)", nameEn: "UW — Public Ivy",
    desc: "✅ 시애틀 소재. 워싱턴주 최고 대학. CS·의대·공대 세계적 수준. 한인 유학생·교수 다수. 주립 대학 학비 $12,000/년 (in-state) | 🔗 uw.edu",
    descEn: "✅ Seattle. WA's top university. World-class CS, med & engineering. Many Korean students & faculty. In-state tuition $12,000/yr | 🔗 uw.edu",
    tags: ["UW", "주립대", "CS"], active: true, order: 4 },
  { id: pid(), emoji: "🎓", name: "Seattle University (시애틀U)", nameEn: "Seattle University",
    desc: "다운타운 소재. 예수회 대학. 법대·비즈니스·간호. 한인 유학생 커뮤니티 활발. 국제학생 장학금 있음 | 🔗 seattleu.edu",
    descEn: "Downtown. Jesuit university. Law, business & nursing. Active Korean student community. International scholarships available | 🔗 seattleu.edu",
    tags: ["시애틀대", "법대", "다운타운"], active: true, order: 5 },
  { id: pid(), emoji: "📚", name: "한인 학원·과외", nameEn: "Korean Tutoring & Hagwon",
    desc: "린우드·벨뷰 한인 학원 다수. SAT·ACT·수학·과학 전문. 한국어 가능 개인 과외 $60-100/시. 카카오오픈채팅 '시애틀한인' → 과외 찾기",
    descEn: "Many Korean tutoring centers in Lynnwood & Bellevue. SAT, ACT, math & science. Korean-speaking tutors $60-100/hr. KakaoTalk '시애틀한인' for tutor listings",
    tags: ["학원", "SAT", "과외"], active: true, order: 6 },
  { id: pid(), emoji: "🌍", name: "국제학생 ESL·어학원", nameEn: "ESL & Language Schools",
    desc: "✅ ELS Language Centers (시애틀). Kaplan International. 커뮤니티 칼리지 ESL 무료·저렴. Edmonds College ESL 추천 (린우드 인근) | 🔗 edcc.edu",
    descEn: "✅ ELS Language Centers (Seattle). Kaplan International. Community college ESL free/low-cost. Edmonds College ESL recommended (near Lynnwood) | 🔗 edcc.edu",
    tags: ["ESL", "어학", "유학생"], active: true, order: 7 },
];

// ─── 생활비 ───────────────────────────────────────────────
export const DEFAULT_COST: PlaceItem[] = [
  { id: pid(), emoji: "🏠", name: "렌트 시세 (2026년 기준)", nameEn: "Rent Prices — 2026",
    desc: "📍 린우드/페더럴웨이: 스튜디오 $1,300-1,700 | 1BR $1,700-2,100 | 2BR $2,100-2,600\n📍 벨뷰: 스튜디오 $1,800-2,300 | 1BR $2,200-2,900 | 2BR $2,800-3,500\n📍 시애틀 시내: 스튜디오 $1,700-2,200 | 1BR $2,100-2,800 | 2BR $2,500-3,200",
    descEn: "📍 Lynnwood/Federal Way: Studio $1,300-1,700 | 1BR $1,700-2,100 | 2BR $2,100-2,600\n📍 Bellevue: Studio $1,800-2,300 | 1BR $2,200-2,900 | 2BR $2,800-3,500\n📍 Downtown Seattle: Studio $1,700-2,200 | 1BR $2,100-2,800 | 2BR $2,500-3,200",
    tags: ["렌트", "주거", "비교"], active: true, order: 0 },
  { id: pid(), emoji: "💵", name: "세금 정보", nameEn: "Tax Information",
    desc: "✅ 워싱턴주 소득세 없음! (큰 장점)\n판매세(Sales Tax): 시애틀 10.4%\n식료품·처방약: 세금 면제\n시애틀 최저시급: $20.76/시 (2026년)\n재산세: 주택 소유 시 연 $5,000-15,000",
    descEn: "✅ WA State has NO income tax! (major benefit)\nSales Tax: 10.4% in Seattle\nGroceries & prescription drugs: tax-exempt\nSeattle minimum wage: $20.76/hr (2026)\nProperty tax: ~$5,000-15,000/yr if you own",
    tags: ["세금", "소득세없음", "최저시급"], active: true, order: 1 },
  { id: pid(), emoji: "🛒", name: "생활비 평균", nameEn: "Average Monthly Expenses",
    desc: "📊 독신 기준 월 예상 생활비:\n• 렌트 (1BR 린우드): $1,800-2,000\n• 식료품: $300-500\n• 교통 (버스+ORCA): $100-130\n• 공과금 (전기·인터넷): $150-200\n• 외식·여가: $200-400\n⟹ 합계: 약 $2,550-3,230/월",
    descEn: "📊 Estimated monthly expenses (single person):\n• Rent (1BR Lynnwood): $1,800-2,000\n• Groceries: $300-500\n• Transit (bus+ORCA): $100-130\n• Utilities (electric+internet): $150-200\n• Dining out & leisure: $200-400\n⟹ Total: ~$2,550-3,230/month",
    tags: ["생활비", "월평균", "예산"], active: true, order: 2 },
  { id: pid(), emoji: "⛽", name: "교통·기름값", nameEn: "Transportation & Gas",
    desc: "🚗 WA주 기름값: $3.80-4.50/갤런 (2026년)\n🚌 Metro 버스: $2.75/회 (ORCA)\n🚇 Link Light Rail: $2.00-3.50 (거리별)\n🅿️ 시애틀 다운타운 주차: $3-8/시간\n💡 린우드 거주 시 대부분 차량 필요",
    descEn: "🚗 WA gas: $3.80-4.50/gallon (2026)\n🚌 Metro bus: $2.75/ride (ORCA)\n🚇 Link Light Rail: $2.00-3.50 (distance-based)\n🅿️ Downtown Seattle parking: $3-8/hr\n💡 Car almost essential if living in Lynnwood",
    tags: ["기름값", "주차", "교통비"], active: true, order: 3 },
  { id: pid(), emoji: "📱", name: "통신비", nameEn: "Phone & Internet",
    ...
    tags: ["통신비", "인터넷", "휴대폰"], active: true, order: 4 },
];
