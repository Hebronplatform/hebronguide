...
"[01:30–02:50] 본격적으로 들어가기 전에, 짧은 영상 하나 보여 드릴게요. 60초쯤 돼요. 어느 이민자의 이야기인데, 사실 우리 모두의 이야기이기도 합니다. (영상 재생) … 보셨죠? 환대가 교회 문 앞에서 시작되지 않았어요. 공항에서, 식당에서, 길에서 시작됐습니다. 오늘 제가 드리고 싶은 이야기가 바로 이거예요.  (연출: 영상 MP4 자동 재생. 끝나면 한 박자 쉬고 다음.)",
"[02:50–04:50] 2001년 6월이었어요. 교회 하나 세워 보겠다고 시애틀에 왔는데, 가진 게 정말 아무것도 없었습니다. 그런데 이 도시가 어찌나 차갑던지, 문을 안 열어 줘요. 그러다 엉뚱한 데서 문이 열렸습니다. 타이완에서 온 아파트 매니저였는데, 불교 신자였어요. 빈 아파트 열쇠를 쥐어 주면서 그러더라고요. '여기 기도하는 데 쓰세요. 대신 다른 사람한테는 말하지 마시고.' 그날 저는 한 대 맞은 것 같았습니다. '저 사람이 예수 믿는 사람이었으면 얼마나 좋았을까.' 그 생각이 25년을 끌고 왔고, HebronGuide가 거기서 시작됐어요.  (연출: 감정의 출발점. 매니저 대사는 잠시 멈춘 뒤 인용.)",
"[04:50–05:50] 마태복음 25장 35절이죠. '내가 나그네 되었을 때에 너희가 영접하였다.' 그날, 그 나그네가 바로 저였어요. 환대라는 거, 그냥 친절한 게 아닙니다. 하나님이 어떤 분이신지를 보여 주는 거예요. 거기엔 네 가지 결이 있는데 — 알아봐 주고, 받아 주고, 채워 주고, 이어 주는 것. 이건 뒤에서 다시 말씀드릴게요.  (연출: 네 단어를 손가락으로 짚듯. 뒤에 다시 나온다고 예고.)",
"[05:50–07:10] 환대를 받아 본 분들 이야기를 들어 보면요. '처음 밥 한 끼 얻어먹고 울었다.' '낯선 동네에서 누가 내 이름을 불러 주더라.' 재밌는 건, 정작 본인들은 그걸 '환대'라고 부르지도 못해요. 그런 말을 몰라서요. 근데 그 순간만큼은 평생 기억합니다. 어떤 분은 '그 일 때문에 교회를 나가게 됐다'고 하시더라고요.  (연출: 왼쪽→오른쪽 순서로. 마지막 줄에 힘.)",
"[07:10–08:30] 그런데 지금 현실은요. 우리 자녀 세대, 열에 여섯이 교회를 떠납니다. 바나 리서치를 보면 교회 안 다니는 청년 87%가 '기독교인은 판단부터 한다'고 답해요. 위선적이다, 85%. 더 아픈 건, 교회 다니는 청년조차 절반이 '우리 교회도 그렇다'고 한다는 거예요. 세상이 우리한테 문을 닫은 게 아닙니다. 우리가 먼저 닫았어요.  (연출: 숫자는 빠르게, 마지막 문장은 무겁게 멈춰서.)",
"[08:30–09:40] 사실 우리가 몰라서 안 하는 게 아니잖아요. '나그네를 대접하라', 다 압니다. 설교도 하고요. 그런데 정작 처음 온 분한테는 아무도 말을 안 걸어요. 다음 주 되면 이름도 까먹고요. 아는 것과 사는 것 사이가 이렇게 멉니다. 왜 그럴까요. 배운 적이 없어서예요. 신학교에서 설교학, 상담학은 배우는데 — 환대는 아무도 안 가르칩니다.  (연출: GAP를 가리키며. '안 가르칩니다'에서 한 박자 쉰다.)",
"[09:40–11:00] 여기서 한 가지 짚고 가야 할 게 있어요. 선교는요, 교회가 벌이는 사업이 아닙니다. 하나님이 먼저 하시는 일이에요. 미시오 데이라고 하죠. 요한복음 1장 14절, 말씀이 사람이 되어 우리 가운데 사셨다 — 하나님이 먼저 이 낯선 땅으로 내려오신 거예요. 그게 환대의 원조입니다. 그러니까 이건 '우리 교회 키우자'는 운동이 아니에요. 우리 모두가 하나님 하시는 일에 함께 끼는, 그런 운동입니다.  (연출: 핵심 신학. 흐름도를 왼→오로. 천천히.)",
"[11:00–12:15] 혹시 에드 스테처의 「선교적 교회 개척」 읽으신 분 계세요? 거기 보면, 우리가 교회에 대해 당연하게 여겼던 걸 뒤집는 통찰이 나와요. 전문 목회자가 있어야 시작된다, 건물이 커야 성장한다, 좋은 설교만 들으면 성숙한다 — 스테처는 이게 오히려 걸림돌일 수 있다고 합니다. 자격증보다 소명, 소유보다 기동성, 설교 의존보다 스스로 말씀을 파는 성도. HebronGuide가 추구하는 게 딱 이거예요. 건물도 전문가도 없이, 흩어진 성도가 일상에서 시작하는 선교적 교회.  (연출: 이 청중은 스테처를 압니다. 빠르게.)",
"[12:15–13:20] 성경이 말하는 환대, 헬라어로 필로세니아예요. '낯선 사람을 사랑한다'는 뜻입니다. 아브라함 기억나시죠. 나그네 셋을 보자마자 달려나가요. 앉아서 기다린 게 아니라 뛰어나갑니다. 바울도 그래요. 아굴라 부부 집, 루디아 집 — 선교가 다 누군가의 집에서 일어났어요. 그래서 저는 이런 생각이 들어요. 초대교회는 어쩌면 '선교적 가정교회'였다고. 멋진 성전이 아니라 집(오이코스)에서, 식탁의 환대로 복음이 흘렀거든요. 건물도 전문가도 없었지만, 그게 가장 강력한 선교였습니다.  (연출: '선교적 가정교회'에서 잠시 멈춤. 스테처·마당 슬라이드와 연결.)",
"[13:20–14:40] 그럼 환대를 어떻게 살아낼 수 있을까요. 가르치려면 좀 손에 잡혀야 하잖아요. 그래서 네 가지로 정리해 봤습니다. 첫째 알아봐 주기 — 이름 불러 주고 눈 맞추는 거요. 둘째 받아 주기 — 따지지 않고요. 셋째 채워 주기 — 진짜 필요한 걸요. 넷째 이어 주기 — 혼자 두지 않고 공동체로요. 만점이 뭐냐고요? 점수표가 아니라, 아브라함처럼 달려나가는 그 모습입니다.  (연출: '계량화 아니냐' 질문 대비. '교육을 위한 것'임을 톤에.)",
"[14:40–15:30] 요즘 우리는 '제4공간'이라는 데서 삽니다. 집이 1공간, 직장이 2공간, 카페 같은 데가 3공간이라면, 온라인과 오프라인이 겹치는 자리가 4공간이에요. 리프킨이 그랬죠. '연결은 됐는데 마음은 더 외로워졌다.' 이 외로운 시대에 가장 예수님다운 대답이 뭘까요. 저는 환대라고 봅니다.  (연출: 익숙한 개념. 빠르게 통과.)",
"[15:30–16:30] HebronGuide가 바로 그 4공간이에요. 저는 이걸 '플랫폼'이라고 안 부르고 '마당'이라고 부릅니다. 예전엔 이민 와서 혼자 검색하고, 교회가 어디 있는지도 몰랐어요. 이제는 공항 나오는 순간부터 믿을 만한 교회, 성도가 하는 가게를 만나는 거예요. 흩어져 사는 성도들의 평범한 하루가 선교 현장이 되는 거죠.  (연출: Before→After 대비. '마당'에 힘.)",
"[16:30–18:00] 말로 백 번 하는 것보다 한번 보시는 게 낫겠죠. 지금 채팅창에 링크 띄워 드릴게요. hebronguide.com입니다. 한번 들어가 보세요. 지금 71개 도시가 돌아가고 있어요. (시연) 도시 하나 누르면 검증된 교회, 성도 가게, 정착 정보가 쭉 나옵니다. 홈 화면에 추가하면 앱처럼 쓰시고요.  (연출: ★실제 화면 공유. 시애틀 한 도시만 깊게. 90초 안에.)",
"[18:00–18:55] 잠깐 그림 하나 그려 볼게요. 어느 도시에 내려도, 공항 문 나서는 순간부터 누가 반겨 주는 세상. 성도가 하는 작은 가게가 누군가한테는 첫 교회가 되는 세상. 그렇게 온 민족이 주님께 돌아오는 마당. 너무 이상적인가요? 그런데 이게 71개 도시에서 벌써 시작됐습니다.  (연출: 슬라이드로 복귀. 그림 그리듯 천천히.)",
"[18:55–19:40] 환대 한 번이 세 군데를 살립니다. 한 사람의 인생이 바뀌고요, 성도의 하루가 예배가 되고, 하나님 나라가 드러나요. 다시 한번 말씀드릴게요. 이건 우리 교회 하나 키우자는 게 아니에요. 우리 모두의 선교입니다.  (연출: 세 손가락. 마지막 문장이 한 줄 요약.)",
"[19:40–20:50] 그래서 부탁을 좀 드리겠습니다. 두 가지요. 하나는, 환대하며 사세요. 거창하게 말고, 이번 주에 낯선 사람 이름 하나 기억하는 것부터요. 또 하나는, 함께 손을 좀 보태 주세요. 목사님들, 교회를 여기 무료로 올려 주세요 (hebronguide.com/church-guide). 성도님 가게 하나라도 등록해 주시고요 (hebronguide.com/ad-request). 이게 돈 드는 일이 아니라 선교예요. 누가 새로 도착했을 때, 공항에서부터 여러분 교회를 만나게 되는 거니까요.  (연출: URL 두 개를 또박또박. 받아적을 시간을 준다.)",
"[20:50–21:40] 요한계시록 7장 9절에 보면, 모든 민족, 모든 언어의 사람들이 셀 수 없이 모여서 하나님께 영광을 돌립니다. 저는 환대가 세상을 바꾼다고 믿어요. 우리가 각자 자리에서 환대하며 살 때, 공동체가 살고, 민족이 돌아오고, 결국 하나님이 영광 받으세요. 같이 해 주시겠어요? 감사합니다. 오직 하나님께 영광입니다.  (연출: 속도를 늦추고 따뜻하게. 자연스럽게 Q&A로 연결.)"
];
...
/* ===== SLIDE 2.5 — 환대의 여정 (영상 자리) ===== */
(() => {
  const s = p.addSlide(); base(s, C.bg2);
  badge(s, "PART 1 · 환대의 여정", 0.9, 0.75);
  title(s, [{text:"한 사람의 ",options:{color:C.white}},{text:"도착",options:{color:C.gold2}},{text:", 그리고 환대",options:{color:C.white}}], 0.9, 1.2, 11.5, 32);
  // 영상 자리 (여기에 MP4를 삽입: 삽입>비디오>이 디바이스, 자동실행)
  card(s, 3.4, 2.55, 6.5, 3.2, "0E1320");
  s.addShape(p.shapes.OVAL, { x:6.18, y:3.45, w:0.95, h:0.95, fill:{color:"15110A"}, line:{color:C.gold2,width:2} });
  s.addText("▶", { x:6.18, y:3.45, w:0.95, h:0.95, fontFace:F, fontSize:22, color:C.gold2, align:"center", valign:"middle", margin:0 });
  s.addText("환대의 여정 — 60초 영상", { x:3.4, y:4.55, w:6.5, h:0.4, fontFace:F, fontSize:15, bold:true, color:C.gold2, align:"center", margin:0 });
  s.addText("이 자리에 MP4 삽입  ·  삽입 → 비디오 → 이 디바이스 → 자동 실행", { x:3.4, y:4.95, w:6.5, h:0.35, fontFace:F, fontSize:11, color:C.mut2, align:"center", margin:0 });
  footer(s, [{text:"공항에서, 거리에서, 가게에서 — ",options:{color:C.mut}},{text:"환대는 교회 입구가 아니라 일상에서 시작됩니다.",options:{color:C.white,bold:true}}], 6.0);
  s.addNotes(NOTES[2]);
})();
...
/* ===== SLIDE 8.5 — 선교적 교회 개척 (스테처) ===== */
(() => {
  const s = p.addSlide(); base(s, "060C16");
  badge(s, "PART 3 · 선교적 교회 개척 (에드 스테처)", 0.9, 0.7);
  title(s, [{text:"당연하다 여긴 것을 ",options:{color:C.white}},{text:"내려놓을 때",options:{color:C.gold2}}], 0.9, 1.15, 11.5, 28);
  twoCol(s,
    "우리가 잘못 알던 것", ["전문 목회자라야 교회를 시작한다","건물이 커야 성장한다","좋은 설교만 들으면 성숙한다","개혁된 교회 — '보내시는 하나님'을 잃다","야망은 곧 죄다"], C.red,
    "HebronGuide의 적용", ["자격증보다 소명 — 평신도가 일상의 환대자","소유보다 기동성 — 건물 없는 디지털 마당","성도가 환대로 복음을 직접 전한다","Missio Dei — 흩어진 성도가 보냄받은 자","하나님 나라 향한 거룩한 야망 (71→500 도시)"], C.mint, 2.1);
  footer(s, [{text:"건물도, 전문가도 없이 — ",options:{color:C.mut}},{text:"흩어진 성도가 일상에서 시작하는 선교적 교회.",options:{color:C.white,bold:true}}], 6.05);
  s.addNotes(NOTES[9]);
})();
...
(() => {
  ...
  twoCol(s,
    ...
    "신약 — 초대교회는 '선교적 가정교회'", ["아굴라·브리스길라의 집에서 (행 18:3)","루디아 — “내 집에 머무르라” (행 16:15)","날마다 집에서 떡을 떼며 (행 2:46)"], C.mint, 2.2);
  footer(s, [{text:"초대교회는 어쩌면 ",options:{color:C.mut}},{text:"'선교적 가정교회'",options:{color:C.gold,bold:true}},{text:"였습니다. 성전이 아니라 ",options:{color:C.mut}},{text:"집(오이코스)에서, 식탁의 환대로 복음이 흘렀습니다.",options:{color:C.white,bold:true}}], 5.95);
  s.addNotes(NOTES[10]);
})();
