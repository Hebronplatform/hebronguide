...
"[12:15–13:20] 성경이 말하는 환대, 헬라어로 필로세니아예요. '낯선 사람을 사랑한다'는 뜻입니다. 아브라함 기억나시죠. 나그네 셋을 보자마자 달려나가요. 앉아서 기다린 게 아니라 뛰어나갑니다. 바울도 그래요. 아굴라 부부 집, 루디아 집 — 선교가 다 누군가의 집에서 일어났어요. 환대가 곧 선교였던 거죠. 하나님이 이걸 명령까지 하시는데, 이유가 뭔지 아세요? '너희도 한때 나그네였잖아.'  (연출: '달려나가'를 강조. 본문 길게 끌지 않는다.)",
